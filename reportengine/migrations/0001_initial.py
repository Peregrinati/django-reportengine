...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reportengine_reportrequest', (
        ...
        db.send_create_signal(u'reportengine', ['ReportRequest'])

        # Adding model 'ReportRequestRow'
        db.create_table(u'reportengine_reportrequestrow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'reportengine', ['ReportRequestRow'])

        # Adding model 'ReportRequestExport'
        db.create_table(u'reportengine_reportrequestexport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request_made', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True)),
            ('completion_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
        ...
        db.send_create_signal(u'reportengine', ['ReportRequestExport'])


    def backwards(self, orm):
        # Deleting model 'ReportRequest'
        db.delete_table(u'reportengine_reportrequest')

        # Deleting model 'ReportRequestRow'
        db.delete_table(u'reportengine_reportrequestrow')

        # Deleting model 'ReportRequestExport'
        db.delete_table(u'reportengine_reportrequestexport')


    models = {
        u'reportengine.reportrequest': {
        ...
        u'reportengine.reportrequestexport': {
            ...
            'report_request': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'exports'", 'to': u"orm['reportengine.ReportRequest']"}),
            'request_made': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
            'task': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'})
        },
        u'reportengine.reportrequestrow': {
            'Meta': {'object_name': 'ReportRequestRow'},
            'data': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report_request': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rows'", 'to': u"orm['reportengine.ReportRequest']"}),
